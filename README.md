<h1 align="center">Blender Classic Pudding Scene</h1>
<p align="center">
🍮 Create a cute, cartoon-style pudding scene with stylized modeling and vibrant materials.
</p>
<p align="center">
---English--- Click on the image to display the image file.
</p>
<div align="center">
<a href="Blender%20Classic%20Pudding/Classic Pudding%20Scene.png">
<img src="Blender%20Classic%20Pudding/Classic Pudding.png" width="600">
</a>
</div>

# Blender-Classic-Pudding
A cute cartoon-style classic pudding scene created in Blender using stylized modeling and vibrant flat materials.

# Overview
This project is a Blender scene featuring a classic caramel pudding with caramel sauce and a cherry on top, served on a plate.
...
- Includes caramel sauce, cherry, and plate props
...
<h1 align="center">Blender Classic Pudding Scene</h1>
<p align="center">
🍮 スタイライズドなモデリングと鮮やかなマテリアルで、かわいいカートゥーン風プリンシーンを作成します。
</p>
<p align="center">
...
# Blender-Classic-Pudding
スタイライズドな3Dモデリングと鮮やかなフラットマテリアルを使用して作成された、カートゥーン風クラシックプリンシーンのBlenderファイルです。

# 概要
このプロジェクトは、カラメルソースとチェリーをトッピングしたクラシックなプリンをお皿に盛り付けたBlenderシーンです。
